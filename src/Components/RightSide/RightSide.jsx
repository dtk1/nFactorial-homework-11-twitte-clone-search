  ...
  render(){
    ...
    return (
      <div className='mx-4 w-25'>
        ...
        <input onChange={handleInputChange} value={inputValue} placeholder='Search Twitter' style={{marginTop: 10, width: '100%',border:'none', borderRadius:40, backgroundColor:'#202327', padding: '10px 80px 10px 40px', marginBottom: 22, color:'white'}}></input>
        </div>
        ...
        <WhoToFollow/>
        <p style={{padding: '7px 14px 27px 22px',borderRadius: '0 0 25px 25px', fontSize: 16, backgroundColor:'#15181C', color: '#1DA1F2'}}>Show More</p> 
        </div>
    )
  }
}
